...
Parameters required for *all* latent transformation approaches:
...
Parameters required for `simulate_by_latent_transform` and `shift_template_experiment` simulation types:
...
Parameters required for `embed_shift_template_experiment` simulation type:
